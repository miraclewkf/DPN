...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-train',    type=str, default='../data/6class_train_Lsoftmax.lst')
    parser.add_argument('--image-train',   type=str, default='/media/mi/data/pornographic/JPEGImages/')
    parser.add_argument('--data-val',      type=str, default='../data/6class_test.lst')
    parser.add_argument('--image-val',     type=str, default='/media/mi/data/pornographic/JPEGImages/')
